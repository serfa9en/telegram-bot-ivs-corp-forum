...
public class Admin extends DataBased{

    private String file;
    private String sheetName = "Admin";
    public Admin(String fileUser) {
        this.file = fileUser;
    }
    ...
    public boolean isPerson(String userId) {
        ...
        try {
            ...
            System.out.println("DataBase: Admin: isPerson");
        }
